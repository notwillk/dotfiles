...

{
  ...
  home.packages = with pkgs;[
    ...
    # (writeShellScriptBin "chrome" "open -a /Applications/Google\ Chrome.app --new --args --new-window")
  ];
  ...
  home.file = {
    ...
    ".gitconfig".source = /Users/${config.home.username}/.dotfiles/gitconfig;
  ...
  # or
  #
  #  /etc/profiles/per-user/willk/etc/profile.d/hm-session-vars.sh
  #
